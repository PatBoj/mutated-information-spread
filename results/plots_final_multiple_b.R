...
#data <- rbind(data, getData("05_04_600_hist/"))
data <- rbind(data, getData("26_06_custom_EN_hist/", "2"))
...
labels_abc <- data.frame(type = c("1", "1", "1", "2", "2", "2"),
                         tau = c(-0.4, 0.2, 0.8, -0.4, 0.2, 0.8),
...
# 5.44
tikz(file = "plots/Results_plot_real-topology.tex", width = inch(17), height = inch(12))
