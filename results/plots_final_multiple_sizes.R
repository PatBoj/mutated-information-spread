...
data <- getData("26_06_60_hist/")
#data <- rbind(data, getData("26_06_600_hist/"))
data <- rbind(data, getData("26_06_6000_hist/"))
...
labels_abc <- data.frame(size = c(60, 60, 60, 6000, 6000, 6000),
...
# 5.44
tikz(file = "plots/Results_plot_sizes.tex", width = inch(17), height = inch(12))
